    ...
    <div class="content-body">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <form style="width: 100%; padding-top: 20px;" action="{{route('web.main_item')}}" method="post">
                            @csrf
                            <div class="form-body">
                                <div class="row">
                    ...
                    <div class="card-header" style="display: flex;justify-content: flex-end;">
                        ...
                        <a href="{{route('web-development.create')}}" class="btn btn-success mb-1 waves-effect waves-light"><i class="feather icon-plus"></i> Добавить</a>
                    </div>
                                ...
                                @foreach($web_dev as $item)
                                    <tr>
                                        ...
                                        <td style="display:flex;flex-wrap:wrap;width:190px;align-items: center;height: 168px;">
                                            <a href="{{route('web-development.show', $item->id)}}" class="btn btn-icon btn-sm btn-success mr-1 mb-1 waves-effect waves-light"><i class="feather icon-edit icon-eye"></i></a>
                                            <a href="{{route('web-development.edit', $item->id)}}" class="btn btn-icon btn-sm btn-warning mr-1 mb-1 waves-effect waves-light"><i class="feather icon-edit"></i></a>
                                            <form action="{{route('web-development.destroy',$item->id)}}" method="post">
                                                @csrf
                                                @method('delete')
        ...
        <div class="bottom">
            ...
            <div class="dataTables_paginate paging_simple_numbers" id="DataTables_Table_0_paginate">
                {{$web_dev->links('vendor.pagination.my_paginate')}}
            </div>
        </div>
