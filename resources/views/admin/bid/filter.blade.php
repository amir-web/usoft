    ...
    <div class="content-body">
                                        ...
                                        <div class="card-body">
                                            <form id="filter_bid" action="{{route('bid_filter')}}" method="get">
                                                <div style="display: flex;align-items: center" class="form-group">
                                                    ...
                                                    <input class="form-control" id="first-name-column" name="date_start" type="date" placeholder="начало" value="{{$_GET['date_start']}}">
                                                </div>
                                                <div style="display: flex; align-items: center" class="form-group">
                                    ...
                                    @foreach($result as $item)
                                        <tr>
                                            ...
                                            <td style="display: flex">
                                                {{--<a href="{{route('bid.edit', $item->id)}}" class="btn btn-icon btn-sm btn-warning mr-1 mb-1 waves-effect waves-light"><i class="feather icon-edit icon-edit"></i></a>--}}
                                                <form action="{{route('bid.destroy',$item->id)}}" method="post">
                                                    @csrf
                                                    @method('delete')
                                                    <button style="margin-top: 0px;" type="submit" class="btn btn-icon btn-sm btn-danger waves-effect waves-light"><i class="feather icon-trash-2"></i></button>
                                                </form>
                                            </td>
                                        </tr>
                                    @endforeach
        ...
        <div class="bottom">
            ...
            <div class="dataTables_paginate paging_simple_numbers" id="DataTables_Table_0_paginate">
                {{$result->links('vendor.pagination.my_paginate')}}
            </div>
        </div>
    </div>
