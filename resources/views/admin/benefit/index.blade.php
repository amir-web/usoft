    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">Только у нас</h2>
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{route('index')}}">Главная</a></li>
                            <li class="breadcrumb-item active">Только у нас</li>
                        </ol>
                    </div>
                </div>
            </div>
    ...
    <div class="content-body">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <form style="width: 100%; padding-top: 20px;" action="{{route('benefit.main_item')}}" method="post">
                            @csrf
                            <div class="form-body">
                                <div class="row">
                    ...
                    <div class="card-header" style="display: flex;justify-content: flex-end;">
                        ...
                        <a href="{{route('benefit.create')}}" class="btn btn-success mb-1 waves-effect waves-light"><i class="feather icon-plus"></i> Добавить</a>
                    </div>
                                    ...
                                    @foreach($benefit as $item)
                                        <tr>
                                            ...
                                            <td style="display:flex;flex-wrap:wrap;width:190px;align-items: center;height: 168px;">
                                                <a href="{{route('benefit.show', $item->id)}}" class="btn btn-icon btn-sm btn-success mr-1 mb-1 waves-effect waves-light"><i class="feather icon-edit icon-eye"></i></a>
                                                <a href="{{route('benefit.edit', $item->id)}}" class="btn btn-icon btn-sm btn-warning mr-1 mb-1 waves-effect waves-light"><i class="feather icon-edit"></i></a>
        ...
        <div class="bottom">
            ...
            <div class="dataTables_paginate paging_simple_numbers" id="DataTables_Table_0_paginate">
                {{$benefit->links('vendor.pagination.my_paginate')}}
            </div>
        </div>
