    ...
    <div class=" section--chit">
        <ul class="breadcrumb">
            <div class="container">
                ...
                <li><a><span>{{__('mobile_app.title')}}</span></a></li>
            </div>
        </ul>
    </div>
        ...
        <div class="container">
            <div class="intro intro--mobile">
                <div class="intro__content intro__content--mobile col-md-8 ">
                    <div class="intro__title intro__title--mobile">{{__('mobile_app.title')}}</div>
                    <div class="intro__text intro--text--mobile col-11  ">
                        ...
                        Fringilla amet et, blandit sit enim. Amet, vel feugiat mauris urna sit. Sed cursus ultricies tristique
                        risus volutpat. Arcu morbi platea sed risus, scelerisque dignissim ullamcorper velit cursus.
                    </div>
                    <a href="#" class="app__btn app__btn--red   col-md-6 col-sm-12 col-xs-10 " data-bs-toggle="modal"
                       data-bs-target="#exampleModal">{{__('website.button')}}</a>
